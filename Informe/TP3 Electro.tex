...
Por último, en la sección final de este trabajo, se buscó determinar analíticamente el valor capacitivo del banco de capacitores que se debería colocar en paralelo a los circuitos del ejercicio 2 para alcanzar un factor de potencia de $ 0,9 $. Realizando las cuentas adecuadas se obtiene que para el circuito de C se requiere un capacitor de $ 16,03 \ \mu F $ mientras que para el circuito RLC se requiere otro de $ 6,54 \ \mu F $. Para el circuito de R, no no tiene sentido colocar en paralelo un capacitor para subir el factor de potencia a $ 0,9 $ ya que el de dicho circuito es de $ 0,99 $.
