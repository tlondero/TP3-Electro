...
\end{itemize} 
Luego de realizar el esquematico y el PCB se preparó para imprimir y se simuló en LTSpice obteniendo el siguiente diagrama de Bode y con su Montecarlo:
