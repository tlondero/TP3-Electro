...
El trabajo permitió constatar la teoría estudiada, viendo sus contraparte práctica. Se pudo analizar el funcionamiento de un transistor y determinación de sus características más importantes, mediante diversos ensayos. Los resultados obtenidos corresponden con lo esperado, teniendo en cuenta la existencia de posibles errores debido a los instrumentos.
